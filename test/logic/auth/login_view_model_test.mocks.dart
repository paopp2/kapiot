...
import 'package:kapiot/data/services/auth_service.dart' as _i5;
...
class MockAppRouter extends _i2.Mock implements _i4.AppRouter {
  ...
  @override
  Map<String, _i1.Widget Function(_i1.BuildContext)> getRoutes() =>
      (super.noSuchMethod(Invocation.method(#getRoutes, []),
              returnValue: <String, _i1.Widget Function(_i1.BuildContext)>{})
          as Map<String, _i1.Widget Function(_i1.BuildContext)>);
  @override
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthService extends _i2.Mock implements _i5.AuthService {
  MockAuthService() {
    _i2.throwOnMissingStub(this);
  }

  @override
  _i6.Reader get read => (super.noSuchMethod(Invocation.getter(#read),
      returnValue: <T>(_i6.ProviderBase<T> provider) => null) as _i6.Reader);
  @override
